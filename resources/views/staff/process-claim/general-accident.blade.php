                ...
                <div class="py-6 px-12">
                    ...
                    <form id="generalAccidentForm">
                        ...
                        <div class="mt-8 pt-4 border-t border-gray-200">
                            <button type="submit"
                                class="w-full md:w-auto px-6 py-2 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition flex items-center justify-center gap-2">
