    ...
    <div class="modal-content">
        <div class="sticky top-0 bg-white border-b border-gray-100 px-6 py-4 flex justify-between items-center">
            <h3 class="text-lg font-bold text-gray-800">
                <i class="fas fa-file-alt text-indigo-500 mr-2"></i>Claim Form
                Details
            </h3>
        ...
        <div class="p-6 space-y-4" id="claimFormContent">
            <!-- dynamic content -->
        </div>
        <div class="bg-gray-50 px-6 py-3 border-t border-gray-300 flex justify-end">
            <button class="close-modal-btn px-4 py-2 bg-indigo-600 text-white rounded-lg text-sm hover:bg-indigo-700">
                Close
            </button>
        </div>
    </div>
