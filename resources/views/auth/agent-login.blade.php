...
<head>
    ...
    <title>Intermediary Portal | Vanguard Assurance</title>
...
<body class="font-sans antialiased min-h-screen flex items-center justify-center p-4 relative">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div class="bg-brand-900 px-6 py-4 text-center">
                <div class="flex items-center justify-center gap-3 mb-1">
                    ...
                    <h2 class="text-lg font-semibold text-white">Intermediary Portal</h2>
                </div>
            ...
            <div class="p-6">
                <div class="mb-4 text-center">
                    <p class="text-gray-600 text-sm">Enter your registered phone number to receive a verification code
                    </p>
                    @if ($errors->any())
                ...
                <form id="agentLoginForm" class="space-y-5">
                    @csrf
                    <div>
    ...
    {{-- AUTH MODAL — Stages: loading | success | otp-entry | error --}}
        ...
        <div id="authModalCard"
            ...
            <div id="stage-success" class="modal-stage">
                <div class="bg-brand-900 px-6 py-5 text-center">
                    ...
                    <p id="success-name" class="text-blue-200 text-sm"></p>
                </div>
            ...
            <div id="stage-otp-entry" class="modal-stage">
                ...
                <div class="p-6">
                    ...
                    <form id="otpForm" class="space-y-5">
                        <div>
                            <label
                                class="block text-xs font-medium text-gray-500 mb-3 text-center uppercase tracking-wide">
    ...
    <script>
        (() => {
            const AJAX_URL = '{{ route('agent.login.ajax') }}';
            const VERIFY_OTP_URL = '{{ route('agent.login.verify.otp') }}';
            const RESEND_OTP_URL = '{{ route('agent.login.resend.otp') }}';
            ...
            function updateOtpValue() {
                document.getElementById('otpValue').value = Array.from(otpDigits).map(i => i.value).join('');
            }
            ...
            // ── Utility buttons ─────────────────────────────────────────────────
            const UNCLOSABLE = ['loading', 'success'];
