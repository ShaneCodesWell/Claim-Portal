...
<body
    ...
    <script>
        ...
        `;
                ...
                // Optional: If form submission fails (e.g., validation error), restore button
                // This would need to be triggered by your backend validation
                // Uncomment if needed:
                /*
                setTimeout(() => {
                    submitBtn.disabled = false;
                    submitBtn.innerHTML = originalBtnContent;
                }, 3000); // Remove this if form actually submits successfully
                */
            });
        });
    </script>
