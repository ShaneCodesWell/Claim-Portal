...
<body
    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-100 relative z-10">
        <div class="bg-brand-900 p-4 text-center relative">
        ...
        <div class="p-8">
            ...
            <form action="{{ route('customer.verify') }}" method="POST" class="space-y-6" id="verificationForm">
                @csrf
                <div>
                    <label for="phone_number" class="block text-sm font-medium text-slate-700 mb-2">Mobile
                        Number</label>
                    <div class="relative">
                        ...
                        <input type="tel" id="phone_number" name="phone_number" placeholder="(233)00 000 0000"
